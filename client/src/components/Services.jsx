...
const ServiceCard = ({ color, title, icon, subtitle, }) => (
    <div className="flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
        ...
        <div className="ml-5 flex flex-col flex-1">
            ...
            <p className="mt-2 text-white text-sm mf:text-base md:w-9/12">{subtitle}</p>
        </div>
    </div>
)
        ...
        <div className="flex flex-col mf:flex-row  w-full justify-center items-center gradient-bg-services">
            ...
            <div className="flex flex-1 flex-col justify-start items-center">
                ...
                <ServiceCard
                    ...
                    subtitle="We give you the best exchange rate for all your transactions, and our services are top-notch."
                />
                <ServiceCard
                    color="bg-[#F84550]"
                    title="Fastest Transactions"
                    icon={<RiHeart2Fill fontSize={21} className="text-white" />}
                    subtitle="We provide the fastest method for any of your transaction, and we also deliver in seconds."
                />
            </div>
        </div>
    );
